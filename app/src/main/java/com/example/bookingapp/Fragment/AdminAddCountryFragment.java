 ...
 * Use the {@link AdminAddCountryFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminAddCountryFragment extends Fragment {
    ...
    public AdminAddCountryFragment() {
     ...
     * @return A new instance of fragment AdminAddCountryFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AdminAddCountryFragment newInstance(String param1, String param2) {
        AdminAddCountryFragment fragment = new AdminAddCountryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_admin_add_country, container, false);
    }
    ...
    {
        img = view.findViewById(R.id.fragadminaddcoun_img);
        id = view.findViewById(R.id.fragadminaddcoun_id);
        name = view.findViewById(R.id.fragadminaddcoun_name);
        ...
        addbtn = view.findViewById(R.id.fragadminaddcoun_addbtn);
    }
    ...
    private void setAddbtn()
    {
        addbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    id.setError("Must have value");
                }
                else
                {
                    db.collection("Country").whereEqualTo("id",idstr)
                            .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                @Override
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if(task.getResult().size() > 0)
                                    {
                                        id.setError("Existed ID");
                                    }
                                    else
                                    {
                                        String namestr = name.getText().toString().trim();
                                        if(namestr.isEmpty() || namestr.length() == 0)
                                            name.setError("Must have value");
                                        else
                                        {
                                            setConfirmPopup(idstr,namestr);
                                        }
                                    }
                                }
                            });
    ...
    private void setInfoAdd(String idstr,String namestr)
    {
        ...
        String path = "bookingapp/countries/" + UUID.randomUUID() + ".png";
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                sr.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        Country country = new Country(idstr,namestr
                                ,task.getResult().toString(),0);
                        db.collection("Country").document(country.getId()).
                                set(country);
    ...
    private void setConfirmPopup(String id,String name)
    {
        ...
        title.setText("CONFIRM COUNTRY");
        maintxt.setText("Are you sure to add this country ?");
    ...
    private void setSuccessPopup()
    {
        ...
        title.setText("ADDED");
        maintxt.setText("You've added this country successfully");
        acc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.cancel();
