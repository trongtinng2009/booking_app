 ...
 * Use the {@link GuestCartFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GuestCartFragment extends Fragment {
     ...
     * @return A new instance of fragment GuestCartFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GuestCartFragment newInstance(String param1, String param2) {
        GuestCartFragment fragment = new GuestCartFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_guest_cart, container, false);
    }
    ...
    private void initView(View view)
    {
        ...
        roomBookingAdapter.setGuestAccess(true);
        db = FirebaseFirestore.getInstance();
    }
    private void setRcv(int status)
    {
        db.collection("RoomBooking").
                whereEqualTo("useraccount.id", MainActivity.user.getId()).
